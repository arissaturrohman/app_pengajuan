...
<div class="row">
    <div class="col-xl-8 col-md-8">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('kelompokUpdate', $kelompok->id) }}" method="POST">
                    @csrf
                    <div class="form-group row">
                      <label for="nama_kelompok" class="col-sm-3 col-form-label">Nama Kelompok</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="nama_kelompok" id="nama_kelompok" value="{{ $kelompok->nama_kelompok }}">
                        @error('nama_kelompok')
