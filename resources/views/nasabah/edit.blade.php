            ...
            <div class="card-body">
                <form action="{{ route('nasabahUpdate', $nasabah->id) }}" method="POST">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="number" class="form-control" name="nik" id="nik" value="{{ $nasabah->NIK }}">
                        @error('nik')
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                          <input type="text" class="form-control" name="nama" id="nama" value="{{ $nasabah->nama }}">
                          @error('nama')
                            <small class="text-danger">
                              {{ $message }}
                            </small>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                          <input type="text" class="form-control" name="tempat_lahir" id="tempat_lahir" value="{{ $nasabah->tempat_lahir }}">
                          @error('tempat_lahir')
                            <small class="text-danger">
                              {{ $message }}
                            </small>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="date" class="form-control" name="tgl_lahir" id="tgl_lahir" value="{{ $nasabah->tgl_lahir }}">
                            @error('tgl_lahir')
                            <small class="text-danger">
                              {{ $message }}
                            </small>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select name="jk" id="jk" class="form-control">
                                ...
                                <option value="Laki-laki" {{ $nasabah->jk == "Laki-laki" ? 'selected' : '' }} >Laki-laki</option>
                                <option value="Perempuan" {{ $nasabah->jk == "Perempuan" ? 'selected' : '' }}>Perempuan</option>
                            </select>
                            @error('jk')
                            <small class="text-danger">
                              {{ $message }}
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="pekerjaan" id="pekerjaan" value="{{ $nasabah->pekerjaan }}">
                            @error('pekerjaan')
                            <small class="text-danger">
                              {{ $message }}
                            </small>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="number" class="form-control" name="pengajuan" id="pengajuan" value="{{ $nasabah->pengajuan }}">
                            @error('pengajuan')
                            <small class="text-danger">
                              {{ $message }}
                            </small>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select name="kelompok_id" id="kelompok_id" class="form-control">
                              ...
                              <option value="{{ $items->id}}" {{ $nasabah->kelompok_id === $items->id ? 'selected' : '' }}>{{ $items->nama_kelompok }}</option>                                  
                              @endforeach
                            </select>
                            @error('kelompok')
                            <small class="text-danger">
